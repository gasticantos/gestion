  ...
  return <div className="max-w-7xl mx-auto flex flex-col gap-6">
    ...
    <Plegable titulo="Nuevo presupuesto">
      <form onSubmit={guardar} className="flex flex-col gap-4">
        ...
        <div className="flex gap-3 items-center"><Button type="submit" variant="primary" disabled={guardando||items.length===0}>{guardando?"Finalizando...":"Finalizar presupuesto"}</Button>{error&&<span className="text-sm text-red-500">{error}</span>}</div>
      </form>
    </Plegable>
