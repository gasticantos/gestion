...
export const REGLAS_RUTA: { prefix: string; roles: Rol[] }[] = [
  ...
  { prefix: "/control-caja", roles: ["DUENIO", "CAJERO"] },
  { prefix: "/api/control-caja", roles: ["DUENIO", "CAJERO"] },
  ...
  { prefix: "/api/productos", roles: ["DUENIO", "CAJERO", "MOZO"] },
  { prefix: "/promos", roles: ["DUENIO", "CAJERO"] },
  { prefix: "/api/promos", roles: ["DUENIO", "CAJERO"] },
  { prefix: "/presupuestos", roles: ["DUENIO", "CAJERO"] },
  { prefix: "/api/presupuestos", roles: ["DUENIO", "CAJERO"] },
