...
export default function VirtualKeyboard({
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-1 gap-1 flex flex-col text-[11px] shadow-xl">
      {onCerrar && (
        <div className="flex justify-end">
          <button type="button" onPointerDown={(e) => { e.preventDefault(); onCerrar(); }} className="px-2 py-0.5 text-neutral-400">
            Cerrar
          </button>
        </div>
      )}
